...
def create_centile_values(sex: str, reference: str = "uk-who", born_preterm=False,):
    """
            ...
            if index <= UK90_TERM_UPPER_THRESHOLD_INDEX:
                ...
                if (born_preterm):
                    if index < 2:  # there is no height data below 25 weeks
                        ...
                        length_for_z = rcpchgrowth.measurement_from_sds(
                            reference=reference, measurement_method="height", requested_sds=sds_value, sex=sex, age=age, born_preterm=born_preterm)
                    weight_for_z = rcpchgrowth.measurement_from_sds(
                        reference=reference, measurement_method="weight", requested_sds=sds_value, sex=sex, age=age, born_preterm=born_preterm)
                    ofc_for_z = rcpchgrowth.measurement_from_sds(
                        reference=reference, measurement_method="ofc", requested_sds=sds_value, sex=sex, age=age, born_preterm=born_preterm)
                    bmi_for_z = None  # there is no UK90 preterm BMI data

                    uk90_preterm_length_sds.append(
                        {"label": centile, "x": age, "y": length_for_z})
                    uk90_preterm_weight_sds.append(
                        {"label": centile, "x": age, "y": weight_for_z})
                    uk90_preterm_bmi_sds.append(
                        {"label": centile, "x": age, "y": bmi_for_z})
                    uk90_preterm_ofc_sds.append(
                        {"label": centile, "x": age, "y": ofc_for_z})
                else:
                ...
                try:
                    ...
                    weight_for_z = None
                try:
                    bmi_for_z = rcpchgrowth.measurement_from_sds(
                        reference=reference, measurement_method="bmi", requested_sds=sds_value, sex=sex, age=age, born_preterm=born_preterm)
                except:
                    bmi_for_z = None
                try:
                    ofc_for_z = rcpchgrowth.measurement_from_sds(
                ...
                who_infant_length_sds.append(
                    {"label": centile, "x": age, "y": length_for_z})
                who_infant_weight_sds.append(
                    {"label": centile, "x": age, "y": weight_for_z})
                who_infant_bmi_sds.append(
                    {"label": centile, "x": age, "y": bmi_for_z})
                who_infant_ofc_sds.append(
                    {"label": centile, "x": age, "y": ofc_for_z})
                ...
                who_child_height_sds.append(
                    {"label": centile, "x": age, "y": length_for_z})
                who_child_weight_sds.append(
                    {"label": centile, "x": age, "y": weight_for_z})
                who_child_bmi_sds.append(
                    {"label": centile, "x": age, "y": bmi_for_z})
                who_child_ofc_sds.append(
                    {"label": centile, "x": age, "y": ofc_for_z})
            else:
                ...
                uk90_child_height_sds.append(
                    {"label": centile, "x": age, "y": length_for_z})
                uk90_child_weight_sds.append(
                    {"label": centile, "x": age, "y": weight_for_z})
                uk90_child_bmi_sds.append(
                    {"label": centile, "x": age, "y": bmi_for_z})
                uk90_child_ofc_sds.append(
                    {"label": centile, "x": age, "y": ofc_for_z})

        height_sds.append({"sds": sds_value, "centile": centile, "uk90_preterm_data": uk90_preterm_length_sds,
                           "who_infant_data": who_infant_length_sds, "who_child_data": who_child_height_sds, "uk90_child_data": uk90_child_height_sds})
        weight_sds.append({"sds": sds_value, "centile": centile, "uk90_preterm_data": uk90_preterm_weight_sds,
                           "who_infant_data": who_infant_weight_sds, "who_child_data": who_child_weight_sds, "uk90_child_data": uk90_child_weight_sds})
        bmi_sds.append({"sds": sds_value, "centile": centile, "uk90_preterm_data": uk90_preterm_bmi_sds,
                        "who_infant_data": who_infant_bmi_sds, "who_child_data": who_child_bmi_sds, "uk90_child_data": uk90_child_bmi_sds})
        ofc_sds.append({"sds": sds_value, "centile": centile, "uk90_preterm_data": uk90_preterm_ofc_sds,
                        "who_infant_data": who_infant_ofc_sds, "who_child_data": who_child_ofc_sds, "uk90_child_data": uk90_child_ofc_sds})
    centiles = {"height": height_sds, "weight": weight_sds,
                "bmi": bmi_sds, "ofc": ofc_sds}
    return centiles
