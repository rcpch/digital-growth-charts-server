...
def create_centile_values(sex: str):
    """
    ...
    centiles= {'height_centiles': height_centiles, 'weight_centiles': weight_centiles, 'bmi_centiles': bmi_centiles, 'ofc_centiles': ofc_centiles}
    return centiles
