...
# It is being deprecated - it does not accept a BMI, nor does it a calculate one from heights and weights
...
def perform_calculation(*,
    ...
    measurement_object = Measurement(sex=sex, birth_date=birth_date, observation_date=observation_date, measurement_method=measurement_method, observation_value=float(observation_value), gestation_weeks=gestation_weeks, gestation_days=gestation_days, default_to_youngest_reference=False)
