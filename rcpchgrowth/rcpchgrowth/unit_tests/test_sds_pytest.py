...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            --0.191649555, 'height', 40.48008, None, True, 'male', 0, id= "Height, Boy, 30Weeks"
         ), 
        pytest.param(
            -0.191649555, 'weight', 1.436, 'male', None, None, 0,  id= "Weight, Boy, 30Weeks"            
        ),
        pytest.param(
            0, 'height', 51, 'male', None, None,  0, id="Height, Boy, Term"
        ),
        pytest.param(
            5, 'height', 109.59, 'male', None, None, 0,  id="Height, Boy, 5 years"
        )
    ],
)
